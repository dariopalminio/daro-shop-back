import { convertAnyToDate, IMarshable } from "hexa-three-levels";
...
*/
export class Reservation implements IMarshable<Reservation> {
    ...
    public createFromAny(unmarshalled: any): Reservation {
        return new Reservation(unmarshalled);
    };
