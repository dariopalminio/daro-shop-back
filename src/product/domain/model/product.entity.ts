...
import { Entity, IMarshable, IValidatable, convertAnyToDate, IEntityFactory } from "hexa-three-levels";
...
export class Product extends Entity implements IValidatable, IMarshable<Product> {
    ...
    */
    ...
    /**
     * Set all attributes from Unmarshalled variable can be of any type 'any' that implements entity interface.
     ...
     */
    private setFromAny(unmarshalled: IProduct) {
